...
- **HTML5 / CSS3 / JavaScript** — no frameworks, no dependencies
- **Google Fonts** — Anybody (display), Work Sans (body), EB Garamond (serif accents)
- **Intersection Observer API** — scroll-triggered reveal animations

## Contact

- **Email:** hentask@gmail.com
- **LinkedIn:** [henry-tasker](https://www.linkedin.com/in/henry-tasker/)
- **GitHub:** [hentask](https://github.com/hentask)
